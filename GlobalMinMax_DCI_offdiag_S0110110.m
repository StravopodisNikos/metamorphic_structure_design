function DCI_star = GlobalMinMax_DCI_offdiag_S0110110(x,s1,s2)
% Objective function that minimizes max(DCI) in each generation
% used for modular_dynamixel/raad2020/InvestigateMassMatrixRAAD2020.m
...
%         wx_diag = [wx(1) wx(2) wx(3) 0 0 0];
        [DCI(p2,p3)] = CalculateDynamicConditioningIndex2_3DoF(Mb,3,wx_offdiag);
    end
end
